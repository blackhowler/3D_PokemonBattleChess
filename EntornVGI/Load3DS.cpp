...
// Load3DS.cpp: Conjunt de funcions per a carregar fitxers amb format gràfic 3DS
...
CLoad3DS::CLoad3DS()
{
	...
	if (m_CurrentChunk==0){
//		MessageBox(NULL, "No hi ha prouta memoria", "Error!", MB_OK);		
		LPCWSTR texte1 = reinterpret_cast<LPCWSTR> ("No hi ha prouta memoria");
...
//	m_FilePointer = fopen(strFileName, "rb");		   // Funció Visual Studio 6.0
	errno = fopen_s(&m_FilePointer,strFileName, "rb"); // Funció Visual 2005 i 2010
...
void CLoad3DS::ProcessNextChunk(t3DModel *pModel, tChunk *pPreviousChunk)
{
	...
	LPCWSTR texte1 = reinterpret_cast<LPCWSTR> ("No hi ha prouta memoria");
	LPCWSTR texte2 = reinterpret_cast<LPCWSTR> ("Error");
	LPCWSTR texte3 = reinterpret_cast<LPCWSTR> ("This 3DS file is over version 3 so it may load incorrectly");
	LPCWSTR texte4 = reinterpret_cast<LPCWSTR> ("Warning");
...
//			MessageBox(NULL, "This 3DS file is over version 3 so it may load incorrectly", "Warning", MB_OK);
			MessageBox(NULL, texte3, texte4, MB_OK);
			break;
...
void CLoad3DS::ProcessNextObjectChunk(t3DModel *pModel, t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	if (m_CurrentChunk==0){
//		MessageBox(NULL, "No hi ha prouta memoria", "Error!", MB_OK);
		LPCWSTR texte1 = reinterpret_cast<LPCWSTR> ("No hi ha prou memoria");
		LPCWSTR texte2 = reinterpret_cast<LPCWSTR> ("Error");
		MessageBox(NULL, texte1, texte2, MB_OK);
		exit(-1);
	}
...
size_t CLoad3DS::GetString(char *pBuffer)
{
	int index = 0;
